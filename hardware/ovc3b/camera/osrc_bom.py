...
def write_components(output_file, components_dict, prefix):
    ...
    for item in line_items:
        ...
        subst = item['subst']
        line = ','.join([str(line_number),qty,ref,footprint,value,tolerance,thermal,voltage,mfn,mpn,dist,distpn,subst])
...
if __name__ == '__main__':
    ...
    with open(out_fn, 'w') as of:
        ...
        of.write("Line Item,Quantity,Designator,Footprint,Value,Tolerance,Thermal,Voltage,Manufacturer,Manufacturer Part Number,Distributor,Distributor Part Number,Substitution OK?\n")
        components = { }
