...
set_property IOSTANDARD LVCMOS12 [get_ports TRIG0]
connect_debug_port dbg_hub/clk [get_nets u_ila_0_pl_clk1]


set_property PACKAGE_PIN G5 [get_ports TRIG0]
...
set_property PACKAGE_PIN AC14 [get_ports {LED0[0]}]
...
set_property PACKAGE_PIN C9 [get_ports TRIG2]
set_property IOSTANDARD LVCMOS12 [get_ports TRIG2]
set_property PACKAGE_PIN D11 [get_ports TRIG3]
set_property IOSTANDARD LVCMOS18 [get_ports TRIG3]
set_property PACKAGE_PIN B4 [get_ports TRIG4]
set_property IOSTANDARD LVCMOS12 [get_ports TRIG4]
set_property PACKAGE_PIN T6 [get_ports TRIG5]
set_property IOSTANDARD LVCMOS12 [get_ports TRIG5]
...
set_property DRIVE 8 [get_ports TRIG3]
