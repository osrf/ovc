...
def sample_packet():
  return [
        ...
        0x08, 0x00,                                      # ethertype
        0x01, 0x00, 0x02, 0x00,  # ip header word 0
        0x03, 0x00, 0x04, 0x00,  # ip header word 1
        0x05, 0x00, 0x06, 0x00,  # ip header word 2
        0x07, 0x00, 0x08, 0x00,  # ip header word 3
        0x09, 0x00, 0x0a, 0x00,  # ip header word 4
        0x0b, 0x00, 0x0c, 0x00,  # udp header word 0
        0x00, 0x0d, 0x00, 0x0e,  # udp header word 1
        0x00, 0x0f, 0x00, 0x10, 0x00, 0x0f, 0x00, 0x10,  # data word 0
...
def udp4_packet():
  return [
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff,  # destination MAC (bcast)
        0x01, 0x02, 0x03, 0x04, 0x05, 0x06,  # source MAC
        0x08, 0x00,                          # ethertype
        0x45, 0x00, 0x00, 0x5c,  # ip header word 0
        0x00, 0x00, 0x40, 0x00,  # ip header word 1
        0x05, 0x00, 0x06, 0x00,  # ip header word 2
        0x07, 0x00, 0x08, 0x00,  # ip header word 3
        0x09, 0x00, 0x0a, 0x00,  # ip header word 4
        0x0b, 0x00, 0x0c, 0x00,  # udp header word 0
...
if __name__ == '__main__':
    ...
    def test():
        data = udp4_packet()
        print(f'data              software  hw64      hw48      hw16      hw')
        print(f'==================================================================')
        yield
        ...
        for i in range(15):
            ...
            if i >= 3:
                ...
                print(f'{old_input:016x}  {crc_so_far:08x}  {c64:08x}  {c48:08x}  {c16:08x}  {c:08x}')
